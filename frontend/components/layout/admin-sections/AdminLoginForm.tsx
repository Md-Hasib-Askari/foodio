                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition"
                                ...
                                <button
                                    ...
                                    className="w-full py-3.5 bg-primary text-white rounded-full font-medium
                  hover:bg-primary-dark transition shadow-sm disabled:opacity-50"
                                ...
                                <button
                                    ...
                                    className="w-full py-3.5 border border-primary text-primary rounded-full font-medium
